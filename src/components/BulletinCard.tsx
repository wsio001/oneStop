  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg px-3 py-2.5 mb-2">
      ...
      <div className="flex justify-between mb-1">
        ...
        <div className="text-[12px] text-gray-500">{post.posted_by}</div>
      </div>

      {/* Subject */}
      <div className="text-[14px] font-medium mb-1">{post.subject}</div>

      {/* Body - preserve newlines, dynamic height to show all text */}
      <div className="text-[12px] text-gray-600 leading-relaxed mb-2 whitespace-pre-line">
        {post.body}
      </div>
      ...
      {post.link_url && (
        <button
          ...
          className="inline-block bg-blue-500 text-white text-[10px] px-2 py-1 rounded-full font-semibold hover:bg-blue-600 transition-colors"
        >
