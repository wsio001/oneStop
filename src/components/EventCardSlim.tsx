...
export default function EventCardSlim({ event }: EventCardSlimProps) {
  return (
    <div className="border-[0.5px] border-gray-200 rounded-lg mb-3 opacity-70" style={{padding: '6px 9px'}}>
      {/* Header: Time */}
      ...
      {/* Notes */}
      {event.notes && (
        <div className="text-[8px] text-gray-500 mt-2 pt-2 border-t border-gray-200 italic">
          {event.notes}
        </div>
      )}
    </div>
